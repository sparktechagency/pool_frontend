...
export const getUsersApi = async (
  ...
  return await howl({
    link: `/admin/get-users?per_page=10&page=${page}${
...
export const getQuoteListingApi = async (
  token: string,
  page: number | string
) => {
  return await howl({
    link: `/admin/get-quote-listing?per_page=10&page=${page}`,
    token,
  });
};
...
export const getTransactionApi = async (
  ...
  return await howl({
    link: `/admin/get-transactions?per_page=10&page=${page}`,
    token,
  });
};
...
export const addCategoryApi = async (token: string, data: FormData) => {
  return await howl({
...
export const updateSubscription = async (
  ...
  return await howl({
    link: `/admin/update-subscription/${id}`,
    method: "post",
    data,
    token,
  });
